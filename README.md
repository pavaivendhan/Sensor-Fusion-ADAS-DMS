...
# Advanced AI-Driven Driver Safety & Fleet Monitoring System 🚙🧠
...
2. **The Edge Controller (ESP32):** Runs strictly compiled C++ for Hard Real-Time operations. It polls the MQ-3 alcohol sensor, parses NEO-6M GPS data, and controls the L298N Motor Driver.
